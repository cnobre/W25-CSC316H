// Load CSV file
d3.csv("data/wealth-health-data.csv", d => {
...
function drawChart(data) {
    ...
    let incomeScaleOld = d3.scaleLinear()
    ...
    let lifeExpectancyScaleOld = d3.scaleLinear()
        .domain([d3.min(data, d => d.LifeExpectancy) , d3.max(data, d => d.LifeExpectancy) ])
        .range([500, 0]);

    // Examples:
    console.log(incomeScaleOld(5000));		// Returns: 23.2763
    console.log(lifeExpectancyScaleOld(68));	// Returns: 224.7191
