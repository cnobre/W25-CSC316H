...
The structure of the file is slightly more sophisticated than the ones you've seen so far. This
 file contains Covid data from the year 2020 and has been cleaned up beforehand. There are
...
Having attended a D3 choropleth bootcamp recently, you think that you're well-equipped for the
 task and agree to help Wiesel. He cries tears of happiness and sends you a [.zip](https://cnobre.github.io/W25-CSC316H/week-08/hw/Template.zip) file with the code
...
1. **Download the resources**
	...
	Download the template: [Template.zip](https://cnobre.github.io/W25-CSC316H/week-08/hw/Template.zip)
